/*
  GAYA Post Renderer
  Owns rendered post HTML and persona preview HTML, including Gaia-style portrait
  layouts, real banner images, bottom banners, focus controls, signatures, and
  post density attributes.
*/
...
function stripInternalPersonaCss(css){
  return stripBannerFitCssLocal(stripFontSizeCssLocal(stripPostSizeCssLocal(stripGayaLayoutCss(css))));
}
