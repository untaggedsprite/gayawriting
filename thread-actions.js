// Thread and reply actions for GAYA.
// Owns thread link hardening, thread editing, reply editing, and edit controls.
(function(){
  const MARK='__gayaThreadActionsInstalled';
  ...
  function install(){
    ...
    }catch(e){console.warn('thread actions refresh skipped',e);}
    return true;
  }
