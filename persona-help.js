...
(function(){
  function addPersonaHelp(){
    ...
    help.innerHTML='<details><summary>quick post-style guide</summary><div class="persona-help-grid"><p><strong>Start simple.</strong> Pick a vibe, then adjust colors, font, pictures, and signature. Presets do not erase the name, avatar, banner, or signature.</p><p><strong>Images.</strong> Upload or paste a URL. PNG, JPG, and WebP resize automatically. GIFs stay animated if they are under 10MB.</p><p><strong>Old-forum layout.</strong> Standard is the plain post card. Gaia style turns on portrait and banner choices. No portrait and no banner are safe buttons.</p><p><strong>Controlled styling.</strong> Presets may add little flourishes behind the scenes, but the editor keeps the scary CSS drawer out of the way.</p><p><strong>Important.</strong> Save persona when the preview looks right. This site is made for desktop/laptop writing; phone viewing is a legally dubious activity.</p></div></details>';
